...
def tabu_search(
    ...
    while count <= iters:
        print('当前轮次：{},最佳策略：{}，最佳代价：{}'.format(count,best_solution_ever,best_cost))
...
"""
当前轮次：1000000,最佳策略：['0', '2', '1', '9', '7', '6', '14', '11', '8', '12', '15', '27', '16', '13', '10', '5', '3', '4', '22', '28', '24', '23', '21', '29', '26', '25', '18', '19', '20', '17', '0']，最佳代价：12105
Best solution: ['0', '2', '1', '9', '7', '6', '14', '11', '8', '12', '15', '27', '16', '13', '10', '5', '3', '4', '22', '28', '24', '23', '21', '29', '26', '25', '18', '19', '20', '17', '0'], with total distance: 12105.
"""